...
/* package BinanceHaskellAPI-0.1.0.0 */
#define VERSION_BinanceHaskellAPI "0.1.0.0"
#define MIN_VERSION_BinanceHaskellAPI(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "BinanceHaskellAPI-0.1.0.0-BCgZtDk5WcQ7EyRB2xSCSq"

#define CURRENT_PACKAGE_KEY "BinanceHaskellAPI-0.1.0.0-BCgZtDk5WcQ7EyRB2xSCSq"
